...
} from "../note-detail/noteActionBarModel";
...
describe(
  ...
  () => {
    it(
      "derives IN_REVIEW actions and preserves guard reasons",
      () => {
        const actions =
          deriveAvailableNoteActions({
            note: createNote(),
    ...
    it(
      "enables approve and reject when their guards pass",
      () => {
        const actions =
          deriveAvailableNoteActions({
            note: createNote(),
    ...
    it(
      "allows workspace state to block otherwise valid actions",
      () => {
        const actions =
          deriveAvailableNoteActions({
            note: createNote({
